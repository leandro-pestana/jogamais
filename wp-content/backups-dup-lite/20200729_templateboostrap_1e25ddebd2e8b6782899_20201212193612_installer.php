...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20200729_templateboostrap_1e25ddebd2e8b6782899_20201212193612_archive.zip';
	const ARCHIVE_SIZE		 = '32930478';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '1e25dde-12193612';
    const SECONDARY_PACKAGE_HASH = 'da00848-12193612';
