...
<nav id="mySidenav" class="sidenav">
    ...
    <ul class="links">
        ...
        <li> <a href="<?php echo get_site_url(); ?>#como-funciona"> Veja como funciona</a></li>
        <li> <a href="<?php echo get_site_url(); ?>#futebol-feminino"> Futebol feminino</a></li>
        <li> <a href="<?php echo get_site_url(); ?>#funcionalidades"> Conheça as funcionalidades</a></li>
